...
To optimize the webSecurity application for production, run:
...
For example, to start a h2 database in a docker container, run:

    docker-compose -f src/main/docker/h2.yml up -d

To stop it and remove the container, run:

    docker-compose -f src/main/docker/h2.yml down
